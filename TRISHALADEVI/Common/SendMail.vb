    ...
    Private Sub cmdok_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdok.Click
        Try
            ...
            If cmbfirstadd.Text.Trim <> Nothing Then
                sendemail(cmbfirstadd.Text.Trim, attachment, txtmailbody.Text.Trim, subject, attachment1)
            End If

            If cmbsecondadd.Text.Trim <> Nothing Then
                sendemail(cmbsecondadd.Text.Trim, attachment, txtmailbody.Text.Trim, subject, attachment1)
            End If

            If cmbthirdadd.Text.Trim <> Nothing Then
                sendemail(cmbthirdadd.Text.Trim, attachment, txtmailbody.Text.Trim, subject, attachment1)
            End If

            If cmbfourthadd.Text.Trim <> Nothing Then
                sendemail(cmbfourthadd.Text.Trim, attachment, txtmailbody.Text.Trim, subject, attachment1)
            End If

            If cmbfifthadd.Text.Trim <> Nothing Then
                sendemail(cmbfifthadd.Text.Trim, attachment, txtmailbody.Text.Trim, subject, attachment1)
            End If
    ...
    Sub cmbvalidate(ByRef cmb As System.Windows.Forms.ComboBox)
        Try
            ...
            If cmb.Text.Trim <> "" Then
                ...
                If dt.Rows.Count = 0 Then
                    Dim tempmsg As Integer = MsgBox("Email Address not present, Add New?", MsgBoxStyle.YesNo, "TRISHALADEVI")
