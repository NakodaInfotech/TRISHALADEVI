...
Public Class GeneralConsentForm
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TRISHALADEVI.GeneralConsentForm.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedGeneralConsentForm
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As GeneralConsentForm = New GeneralConsentForm()
        rpt.Site = Me.Site
        Return rpt
    End Function
