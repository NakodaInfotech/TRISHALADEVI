...
Public Class OPDReportDetailsA5
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TRISHALADEVI.OPDReportDetailsA5.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedOPDReportDetailsA5
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As OPDReportDetailsA5 = New OPDReportDetailsA5()
        rpt.Site = Me.Site
        Return rpt
    End Function
