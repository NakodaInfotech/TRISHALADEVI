...
Public Class OperativeNotesAnaesthesia
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "OperativeNotes(Anaesthesia).rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TRISHALADEVI.OperativeNotes(Anaesthesia).rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedOperativeNotesAnaesthesia
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As OperativeNotesAnaesthesia = New OperativeNotesAnaesthesia()
        rpt.Site = Me.Site
        Return rpt
    End Function
