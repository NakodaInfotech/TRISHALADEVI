...
Public Class OperativeNotes
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TRISHALADEVI.OperativeNotes.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedOperativeNotes
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As OperativeNotes = New OperativeNotes()
        rpt.Site = Me.Site
        Return rpt
    End Function
