...
Public Class OPDAllBillsReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TRISHALADEVI.OPDAllBillsReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedOPDAllBillsReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As OPDAllBillsReport = New OPDAllBillsReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
