...
Public Class ClaimRequestReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TRISHALADEVI.ClaimRequestReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedClaimRequestReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ClaimRequestReport = New ClaimRequestReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
