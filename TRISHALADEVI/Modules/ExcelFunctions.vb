...
#Region "EXCEL HEADER"
    ...
    Sub Write(ByVal OBJSHEET As Excel.Worksheet, ByVal Text As Object, ByVal Range As String, ByVal Align As XlHAlign,
        Optional ByVal ToRange As String = Nothing, Optional ByVal FontBold As Boolean = False,
