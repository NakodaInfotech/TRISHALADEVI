...
Public Class DBConnection
    ...
    'Public Shared ConnectionString As String = "Data Source=" & SERVERNAME & ";Initial Catalog=TRISHALADEVI;User ID=sa;Password=infosys123;connection timeout=2000"
    'Public Shared ConnectionString As String = "Data Source=" & SERVERNAME & ";Initial Catalog=TRISHALADEVI;Integrated Security=True;connect timeout=9999"
